# author: Satria Mandala P
# team: MASKEDCLOWN CODE
# Ig : @satriamandallaa
...
#    runntxt(h+"     Assalamu'alaikum       .")
    ...
    print s+"+---------------------------------------------+"
    maskedclown ("\ra|  Author:\rh SATRIA MANDALA P")
    maskedclown ("\ra|  Team  :\rh MASKEDCLOWN")
    maskedclown ("\ra|  github:\rh https://www.github.com/maskedclown")
    print s+"|   +-----------------------------------------+"
    maskedclown("\rm|   | \rm[\rs1\rm]\rk  Ubah termux kamu sekarang          |")
